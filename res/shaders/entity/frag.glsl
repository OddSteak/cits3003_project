...
void main() {
    ...
    vec2 scaled_uv = frag_in.texture_coordinate * texture_scale;
    vec3 resolved_lighting = resolve_textured_light_calculation(frag_in.lighting_result, diffuse_texture, specular_map_texture, scaled_uv);
